...
public class CancellationError {
    public static void main(String[] args) {
       // compute series from leftToRight
        double sumLeftToRight = 0.0;
        for (double i = 1.0; i <= 50000.0; i++) {
            sumLeftToRight += 1 / i;
        }
        // display results of series sum from left to right
        ...
        /* compare the results */
        System.out.println("Summation of the series right to left - " + "Summation "
                + "of the series left to right: \n" + (sumRightToLeft - sumLeftToRight));
    }
